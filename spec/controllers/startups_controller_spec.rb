  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved startup as @startup" do
        ...
        post :create, {:startup => {  }}, valid_session
        assigns(:startup).should be_a_new(Startup)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested startup" do
        ...
        Startup.any_instance.should_receive(:update_attributes).with({ "these" => "params" })
        put :update, {:id => startup.to_param, :startup => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the startup as @startup" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Startup.any_instance.stub(:save).and_return(false)
        put :update, {:id => startup.to_param, :startup => {  }}, valid_session
        assigns(:startup).should eq(startup)
      end
